...
def ensure_schema(con: sqlite3.Connection) -> None:
    ...
    try:
        con.execute("ALTER TABLE line_config ADD COLUMN mec_perf_inclinada INTEGER DEFAULT 0")
    except sqlite3.OperationalError:
        pass  # Column already exists
    
    try:
        con.execute("ALTER TABLE line_config ADD COLUMN sobre_medida_mecanizado INTEGER DEFAULT 0")
    except sqlite3.OperationalError:
        pass  # Column already exists